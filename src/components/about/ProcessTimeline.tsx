...
export function ProcessTimeline() {
  ...
  return (
    <section id="process" className="py-40 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto border-t border-white/5">
      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="absolute left-[27px] md:left-1/2 top-0 bottom-0 w-[1px] bg-gradient-to-b from-transparent via-white/10 to-transparent md:-translate-x-1/2" />
